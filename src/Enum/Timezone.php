...
enum Timezone: string
{
    ...
    private const array TIMEZONE_BY_COUNTRY_CODE = [
        Country::AFGHANISTAN->value => self::ASIA_KABUL,
        Country::ALBANIA->value => self::EUROPE_TIRANE,
        Country::ALGERIA->value => self::AFRICA_ALGIERS,
        Country::AMERICAN_SAMOA->value => self::PACIFIC_PAGO_PAGO,
        Country::ANDORRA->value => self::EUROPE_ANDORRA,
        Country::ANGOLA->value => self::AFRICA_LUANDA,
        Country::ANGUILLA->value => self::AMERICA_ANGUILLA,
        Country::ANTARCTICA->value => self::ANTARCTICA_PALMER,
        Country::ANTIGUA_AND_BARBUDA->value => self::AMERICA_ANTIGUA,
        Country::ARGENTINA->value => self::AMERICA_ARGENTINA_BUENOS_AIRES,
        Country::ARMENIA->value => self::ASIA_YEREVAN,
        Country::ARUBA->value => self::AMERICA_ARUBA,
        Country::AUSTRALIA->value => self::AUSTRALIA_SYDNEY,
        Country::AUSTRIA->value => self::EUROPE_VIENNA,
        Country::AZERBAIJAN->value => self::ASIA_BAKU,
        Country::BAHAMAS->value => self::AMERICA_NASSAU,
        Country::BAHRAIN->value => self::ASIA_BAHRAIN,
        Country::BANGLADESH->value => self::ASIA_DHAKA,
        Country::BARBADOS->value => self::AMERICA_BARBADOS,
        Country::BELARUS->value => self::EUROPE_MINSK,
        Country::BELGIUM->value => self::EUROPE_BRUSSELS,
        Country::BELIZE->value => self::AMERICA_BELIZE,
        Country::BENIN->value => self::AFRICA_PORTO_NOVO,
        Country::BERMUDA->value => self::ATLANTIC_BERMUDA,
        Country::BHUTAN->value => self::ASIA_THIMPHU,
        Country::BOLIVIA->value => self::AMERICA_LA_PAZ,
        Country::BOSNIA_AND_HERZEGOVINA->value => self::EUROPE_SARAJEVO,
        Country::BOTSWANA->value => self::AFRICA_GABORONE,
        Country::BRAZIL->value => self::AMERICA_SAO_PAULO,
        Country::BRUNEI_DARUSSALAM->value => self::ASIA_BRUNEI,
        Country::BULGARIA->value => self::EUROPE_SOFIA,
        Country::BURKINA_FASO->value => self::AFRICA_OUAGADOUGOU,
        Country::BURUNDI->value => self::AFRICA_BUJUMBURA,
        Country::CABO_VERDE->value => self::ATLANTIC_CAPE_VERDE,
        Country::CAMBODIA->value => self::ASIA_PHNOM_PENH,
        Country::CAMEROON->value => self::AFRICA_DOUALA,
        Country::CANADA->value => self::AMERICA_TORONTO,
        Country::CENTRAL_AFRICAN_REPUBLIC->value => self::AFRICA_BANGUI,
        Country::CHAD->value => self::AFRICA_NDJAMENA,
        Country::CHILE->value => self::AMERICA_SANTIAGO,
        Country::CHINA->value => self::ASIA_SHANGHAI,
        Country::COLOMBIA->value => self::AMERICA_BOGOTA,
        Country::COMOROS->value => self::INDIAN_COMORO,
        Country::CONGO->value => self::AFRICA_BRAZZAVILLE,
        Country::CONGO_DEMOCRATIC_REPUBLIC->value => self::AFRICA_KINSHASA,
        Country::COSTA_RICA->value => self::AMERICA_COSTA_RICA,
        Country::CROATIA->value => self::EUROPE_ZAGREB,
        Country::CUBA->value => self::AMERICA_HAVANA,
        Country::CYPRUS->value => self::ASIA_NICOSIA,
        Country::CZECHIA->value => self::EUROPE_PRAGUE,
        Country::DENMARK->value => self::EUROPE_COPENHAGEN,
        Country::DJIBOUTI->value => self::AFRICA_DJIBOUTI,
        Country::DOMINICA->value => self::AMERICA_DOMINICA,
        Country::DOMINICAN_REPUBLIC->value => self::AMERICA_SANTO_DOMINGO,
        Country::ECUADOR->value => self::AMERICA_GUAYAQUIL,
        Country::EGYPT->value => self::AFRICA_CAIRO,
        Country::EL_SALVADOR->value => self::AMERICA_EL_SALVADOR,
        Country::EQUATORIAL_GUINEA->value => self::AFRICA_MALABO,
        Country::ERITREA->value => self::AFRICA_ASMARA,
        Country::ESTONIA->value => self::EUROPE_TALLINN,
        Country::ESWATINI->value => self::AFRICA_MBABANE,
        Country::ETHIOPIA->value => self::AFRICA_ADDIS_ABABA,
        Country::FIJI->value => self::PACIFIC_FIJI,
        Country::FINLAND->value => self::EUROPE_HELSINKI,
        Country::FRANCE->value => self::EUROPE_PARIS,
        Country::GABON->value => self::AFRICA_LIBREVILLE,
        Country::GAMBIA->value => self::AFRICA_BANJUL,
        Country::GEORGIA->value => self::ASIA_TBILISI,
        Country::GERMANY->value => self::EUROPE_BERLIN,
        Country::GHANA->value => self::AFRICA_ACCRA,
        Country::GREECE->value => self::EUROPE_ATHENS,
        Country::GUATEMALA->value => self::AMERICA_GUATEMALA,
        Country::GUINEA->value => self::AFRICA_CONAKRY,
        Country::GUINEA_BISSAU->value => self::AFRICA_BISSAU,
        Country::GUYANA->value => self::AMERICA_GUYANA,
        Country::HAITI->value => self::AMERICA_PORT_AU_PRINCE,
        Country::HONDURAS->value => self::AMERICA_TEGUCIGALPA,
        Country::HUNGARY->value => self::EUROPE_BUDAPEST,
        Country::ICELAND->value => self::ATLANTIC_REYKJAVIK,
        Country::INDIA->value => self::ASIA_KOLKATA,
        Country::INDONESIA->value => self::ASIA_JAKARTA,
        Country::IRAN->value => self::ASIA_TEHRAN,
        Country::IRAQ->value => self::ASIA_BAGHDAD,
        Country::IRELAND->value => self::EUROPE_DUBLIN,
        Country::ISRAEL->value => self::ASIA_JERUSALEM,
        Country::ITALY->value => self::EUROPE_ROME,
        Country::JAMAICA->value => self::AMERICA_JAMAICA,
        Country::JAPAN->value => self::ASIA_TOKYO,
        Country::JORDAN->value => self::ASIA_AMMAN,
        Country::KAZAKHSTAN->value => self::ASIA_ALMATY,
        Country::KENYA->value => self::AFRICA_NAIROBI,
        Country::KIRIBATI->value => self::PACIFIC_TARAWA,
        Country::KUWAIT->value => self::ASIA_KUWAIT,
        Country::KYRGYZSTAN->value => self::ASIA_BISHKEK,
        Country::LAO_PEOPLES_DEMOCRATIC_REPUBLIC->value => self::ASIA_VIENTIANE,
        Country::LATVIA->value => self::EUROPE_RIGA,
        Country::LEBANON->value => self::ASIA_BEIRUT,
        Country::LESOTHO->value => self::AFRICA_MASERU,
        Country::LIBERIA->value => self::AFRICA_MONROVIA,
        Country::LIBYA->value => self::AFRICA_TRIPOLI,
        Country::LIECHTENSTEIN->value => self::EUROPE_VADUZ,
        Country::LITHUANIA->value => self::EUROPE_VILNIUS,
        Country::LUXEMBOURG->value => self::EUROPE_LUXEMBOURG,
        Country::MADAGASCAR->value => self::INDIAN_ANTANANARIVO,
        Country::MALAWI->value => self::AFRICA_BLANTYRE,
        Country::MALAYSIA->value => self::ASIA_KUALA_LUMPUR,
        Country::MALDIVES->value => self::INDIAN_MALDIVES,
        Country::MALI->value => self::AFRICA_BAMAKO,
        Country::MALTA->value => self::EUROPE_MALTA,
        Country::MARSHALL_ISLANDS->value => self::PACIFIC_MAJURO,
        Country::MAURITANIA->value => self::AFRICA_NOUAKCHOTT,
        Country::MAURITIUS->value => self::INDIAN_MAURITIUS,
        Country::MEXICO->value => self::AMERICA_MEXICO_CITY,
        Country::MONACO->value => self::EUROPE_MONACO,
        Country::MONGOLIA->value => self::ASIA_ULAANBAATAR,
        Country::MONTENEGRO->value => self::EUROPE_PODGORICA,
        Country::MOROCCO->value => self::AFRICA_CASABLANCA,
        Country::MOZAMBIQUE->value => self::AFRICA_MAPUTO,
        Country::MYANMAR->value => self::ASIA_YANGON,
        Country::NAMIBIA->value => self::AFRICA_WINDHOEK,
        Country::NEPAL->value => self::ASIA_KATHMANDU,
        Country::NETHERLANDS->value => self::EUROPE_AMSTERDAM,
        Country::NEW_ZEALAND->value => self::PACIFIC_AUCKLAND,
        Country::NICARAGUA->value => self::AMERICA_MANAGUA,
        Country::NIGER->value => self::AFRICA_NIAMEY,
        Country::NIGERIA->value => self::AFRICA_LAGOS,
        Country::NORWAY->value => self::EUROPE_OSLO,
        Country::OMAN->value => self::ASIA_MUSCAT,
        Country::PAKISTAN->value => self::ASIA_KARACHI,
        Country::PALAU->value => self::PACIFIC_PALAU,
        Country::PANAMA->value => self::AMERICA_PANAMA,
        Country::PAPUA_NEW_GUINEA->value => self::PACIFIC_PORT_MORESBY,
        Country::PARAGUAY->value => self::AMERICA_ASUNCION,
        Country::PERU->value => self::AMERICA_LIMA,
        Country::PHILIPPINES->value => self::ASIA_MANILA,
        Country::POLAND->value => self::EUROPE_WARSAW,
        Country::PORTUGAL->value => self::EUROPE_LISBON,
        Country::QATAR->value => self::ASIA_QATAR,
        Country::ROMANIA->value => self::EUROPE_BUCHAREST,
        Country::RUSSIA->value => self::EUROPE_MOSCOW,
        Country::RWANDA->value => self::AFRICA_KIGALI,
        Country::SAUDI_ARABIA->value => self::ASIA_RIYADH,
        Country::SENEGAL->value => self::AFRICA_DAKAR,
        Country::SERBIA->value => self::EUROPE_BELGRADE,
        Country::SINGAPORE->value => self::ASIA_SINGAPORE,
        Country::SLOVAKIA->value => self::EUROPE_BRATISLAVA,
        Country::SLOVENIA->value => self::EUROPE_LJUBLJANA,
        Country::SOLOMON_ISLANDS->value => self::PACIFIC_GUADALCANAL,
        Country::SOMALIA->value => self::AFRICA_MOGADISHU,
        Country::SOUTH_AFRICA->value => self::AFRICA_JOHANNESBURG,
        Country::SPAIN->value => self::EUROPE_MADRID,
        Country::SRI_LANKA->value => self::ASIA_COLOMBO,
        Country::SUDAN->value => self::AFRICA_KHARTOUM,
        Country::SURINAME->value => self::AMERICA_PARAMARIBO,
        Country::SWEDEN->value => self::EUROPE_STOCKHOLM,
        Country::SWITZERLAND->value => self::EUROPE_ZURICH,
        Country::SYRIA->value => self::ASIA_DAMASCUS,
        Country::TAIWAN->value => self::ASIA_TAIPEI,
        Country::TAJIKISTAN->value => self::ASIA_DUSHANBE,
        Country::TANZANIA->value => self::AFRICA_DAR_ES_SALAAM,
        Country::THAILAND->value => self::ASIA_BANGKOK,
        Country::TIMOR_LESTE->value => self::ASIA_DILI,
        Country::TOGO->value => self::AFRICA_LOME,
        Country::TONGA->value => self::PACIFIC_TONGATAPU,
        Country::TRINIDAD_AND_TOBAGO->value => self::AMERICA_PORT_OF_SPAIN,
        Country::TUNISIA->value => self::AFRICA_TUNIS,
        Country::TURKEY->value => self::EUROPE_ISTANBUL,
        Country::TURKMENISTAN->value => self::ASIA_ASHGABAT,
        Country::UGANDA->value => self::AFRICA_KAMPALA,
        Country::UKRAINE->value => self::EUROPE_KYIV,
        Country::UNITED_ARAB_EMIRATES->value => self::ASIA_DUBAI,
        Country::UNITED_KINGDOM->value => self::EUROPE_LONDON,
        Country::UNITED_STATES->value => self::AMERICA_NEW_YORK,
        Country::URUGUAY->value => self::AMERICA_MONTEVIDEO,
        Country::UZBEKISTAN->value => self::ASIA_TASHKENT,
        Country::VANUATU->value => self::PACIFIC_EFATE,
        Country::VENEZUELA->value => self::AMERICA_CARACAS,
        Country::VIETNAM->value => self::ASIA_HO_CHI_MINH,
        Country::YEMEN->value => self::ASIA_ADEN,
        Country::ZAMBIA->value => self::AFRICA_LUSAKA,
        Country::ZIMBABWE->value => self::AFRICA_HARARE,
    ];

    public static function findByCountry(Country $country): ?self
    {
        return self::TIMEZONE_BY_COUNTRY_CODE[$country->value] ?? null;
    }
}
